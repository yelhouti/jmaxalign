...
public class Trainer{
	private String configOutputFile;
	...
	public Trainer(String lang1, String lang2){
		l1 = lang1;
		l2 = lang2;
		
		configOutputFile = j.getCorporaPath(l1, l2) + "alignment.config";
		 analyzeTrainingData();
...
//		generatePhraseProbabilities();
	...
	private void generateConfigFile(){
		try{
			File out = new File(configOutputFile);
			...
			configOutput.println("execDir	" + j.getTrainingAlignDirectoryPath(l1, l2));
			...
			configOutput.println("trainSources	" + j.getTrainDirectory(l1, l2));
	 ...
	 * corpora   
	 */
	private void generateWordAlignments(){
		//This creates an aligner 
		String[] args = new String[1];
		args[0] = "++" + configOutputFile;
		Main main = new Main();
